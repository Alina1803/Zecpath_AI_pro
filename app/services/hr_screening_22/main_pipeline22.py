...
def build_dynamic_questions(role):
    ...
    role_data = category_mapping.get(role, {})

    role_skills = role_data.get("skills", [])

    generated_questions = generate_ca_questions(skills=role_skills)
...
def enhance_with_hr_screening(result, resume_file):
    ...
    result["ats_score"] = result.get("ats_score", 0) + bonus
    ...
    generated_questions = build_dynamic_questions(role)
    ...
    for question in questions_data:
        ...
        try:
            ...
            ai_questions.append(build_question_object(question))

        except Exception as e:

            print(f"Question Object Error: {e}")
    ...
    result["message"] = "Candidate shortlisted " "for HR interview"
...
# =========================================================
@app.post("/process")
async def process_resume_api(resume: UploadFile = File(...), jd: str = Form(...)):
...
def process_resumes_direct():
    ...
    print("\n🚀 Running DAY 22 " "DIRECT PIPELINE\n")
    ...
    for file in os.listdir(RESUME_FOLDER):
        ...
        try:
            ...
            print(f"Message : " f"{final_result.get('message')}")
        ...
        try:
            ...
            with open(path, "rb") as f:
                ...
                response = requests.post(
                    API_URL, files={"resume": f}, data={"jd": jd_text}
                )
