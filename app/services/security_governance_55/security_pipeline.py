...
from app.services.security_governance_55.security_report_generator import (SecurityReportGenerator)
...
app = FastAPI(
    title="Zecpath Security & AI Governance",
    version="55.0"
)
...
class SecurityPipeline:
    ...
    def run(self, candidate):
        ...
        consent = ConsentManager().capture_consent(
            candidate_id
        )
