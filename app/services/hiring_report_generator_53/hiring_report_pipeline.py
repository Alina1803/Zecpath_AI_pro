...
class HiringReportPipeline:
    ...
    def generate(self, candidate_data):
        ...
        technical_report = RecommendationEngine.generate(candidate_data)
        ...
        integrity_risk = risk_flagging(candidate_data.get("integrity_score", 0))
        ...
        combined_results = {
            "candidate_id": candidate_data.get("candidate_id"),
            "technical_confidence": candidate_data.get("technical_score"),
            "behavioral_confidence": candidate_data.get("confidence_score"),
            "overall_confidence": confidence / 10,
            "semantic_score": candidate_data.get("technical_score"),
            "domain_score": candidate_data.get("system_design_score"),
            "communication_strength": candidate_data.get("communication_score"),
            "sentiment_score": candidate_data.get("sentiment_score"),
            "flags": technical_report.get("risks"),
            "experience": candidate_data.get("experience"),
            "salary_expectation": candidate_data.get("salary_expectation"),
            "final_score": technical_report.get("final_score"),
        }

        final_report = ReportGenerator().generate(combined_results)
