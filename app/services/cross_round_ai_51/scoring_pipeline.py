...
def aggregation_pipeline(data):
    ...
    return {
        ...
        "ranking": ranking,
        "analytics": candidate_strength(normalized_scores),
        "explanation": explain_scores(normalized_scores),
        "recruiter_summary": recruiter_summary(data.candidate_id, final_score),
    }
